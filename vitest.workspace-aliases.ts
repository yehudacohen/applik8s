...
export function workspaceAliases(): Record<string, string> {
  return {
    ...
    '@applik8s/applik8s/provider-telemetry-runtime': fileURLToPath(new URL('./packages/applik8s/src/application-provider-telemetry-runtime.ts', import.meta.url)),
    ...
    '@applik8s/applik8s/query-batch-runtime': fileURLToPath(new URL('./packages/applik8s/src/query-batch-runtime.ts', import.meta.url)),
    ...
    '@applik8s/code-agent/runtime-contract': fileURLToPath(new URL('./packages/code-agent/src/runtime-contract.ts', import.meta.url)),
    '@applik8s/code-agent/http': fileURLToPath(new URL('./packages/code-agent/src/http.ts', import.meta.url)),
    '@applik8s/code-agent/runtime': fileURLToPath(new URL('./packages/code-agent/src/runtime.ts', import.meta.url)),
    '@applik8s/code-agent': fileURLToPath(new URL('./packages/code-agent/src/index.ts', import.meta.url)),
    ...
    '@applik8s/dev/agent/opencode-code-harness': fileURLToPath(new URL('./packages/dev/src/agent/opencode-code-harness.ts', import.meta.url)),
    ...
    '@applik8s/core/managed-model': fileURLToPath(new URL('./packages/core/src/managed-model.ts', import.meta.url)),
    ...
    '@applik8s/runtime-kubernetes/workflow-gateway-admission': fileURLToPath(new URL('./packages/runtime-kubernetes/src/workflow-gateway-admission.ts', import.meta.url)),
    '@applik8s/runtime-kubernetes/managed-model-store': fileURLToPath(new URL('./packages/runtime-kubernetes/src/managed-model-store.ts', import.meta.url)),
    '@applik8s/runtime-kubernetes/operator-runtime': fileURLToPath(new URL('./packages/runtime-kubernetes/src/operator-runtime.ts', import.meta.url)),
    ...
    '@applik8s/runtime-postgres/managed-model-store': fileURLToPath(new URL('./packages/runtime-postgres/src/managed-model-store.ts', import.meta.url)),
    '@applik8s/runtime-postgres/operator-runtime': fileURLToPath(new URL('./packages/runtime-postgres/src/operator-runtime.ts', import.meta.url)),
    '@applik8s/runtime-postgres/saga-store': fileURLToPath(new URL('./packages/runtime-postgres/src/saga-store.ts', import.meta.url)),
    '@applik8s/runtime-postgres/query-batch': fileURLToPath(new URL('./packages/runtime-postgres/src/query-batch.ts', import.meta.url)),
    '@applik8s/runtime-postgres/query-selection': fileURLToPath(new URL('./packages/runtime-postgres/src/query-selection.ts', import.meta.url)),
    '@applik8s/runtime-postgres/sql': fileURLToPath(new URL('./packages/runtime-postgres/src/sql.ts', import.meta.url)),
