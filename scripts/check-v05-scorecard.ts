...
const dimensions: readonly Dimension[] = [
  ...
  dimension('Kubernetes connections',
    check('strict-bindings', await contains('packages/compiler/src/manifest/index.ts', 'bindKubernetesConnections') && await contains('packages/applik8s/src/cli.ts', '--connection-bindings'), 'Programmatic and CLI compilation require exact, validated alias-to-Secret bindings.'),
