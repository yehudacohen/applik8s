...
function managedApplicationAgenticStartPackage(
  ...
  const maintainedDependencies = {
    ...
    '@applik8s/client': version,
    '@applik8s/core': version,
    ...
    '@applik8s/research': version,
    '@applik8s/web-search': version,
    '@applik8s/web-search-searxng': version,
    '@applik8s/web-retrieval-http': version,
    '@applik8s/runtime': version,
    '@applik8s/runtime-ai': version,
    '@applik8s/runtime-aws': version,
    '@applik8s/runtime-celld': version,
    '@applik8s/runtime-duckdb': version,
    '@applik8s/runtime-hatchet': version,
    '@applik8s/runtime-kubernetes': version,
    '@applik8s/runtime-nats': version,
    '@applik8s/runtime-otel': version,
    '@applik8s/runtime-postgres': version,
    '@applik8s/runtime-contract': version,
  ...
  return Object.freeze({
    ...
    scripts: Object.freeze({
      ...
      plan: 'bun run build && applik8s plan --profile developer',
      deploy: 'bun run build && applik8s deploy --profile developer',
      'dev:cluster': 'bun run build && applik8s deploy --profile developer --development --instance kubernetes/application.yaml',
      'dev:live': 'bun run build && applik8s deploy --profile developer --development --instance kubernetes/application.developer.yaml',
