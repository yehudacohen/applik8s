...
export function applik8sWorkspaceSourcePlugin(): Plugin {
  ...
  const packageAliases = new Map<string, string>([
    ...
    ['@applik8s/web-search/source-runtime', resolve(workspaceRoot, 'packages/web-search/src/source-runtime.ts')],
    ['@applik8s/web-search', resolve(workspaceRoot, 'packages/web-search/src/index.ts')],
    ['@applik8s/web-retrieval-http/runtime', resolve(workspaceRoot, 'packages/web-retrieval-http/src/runtime.ts')],
    ['@applik8s/web-retrieval-http', resolve(workspaceRoot, 'packages/web-retrieval-http/src/index.ts')],
    ['@applik8s/research/runtime', resolve(workspaceRoot, 'packages/research/src/runtime.ts')],
    ['@applik8s/research/postgres', resolve(workspaceRoot, 'packages/research/src/postgres.ts')],
    ['@applik8s/research', resolve(workspaceRoot, 'packages/research/src/index.ts')],
