...
${mixedQueryMultiplex}
${observability ? generatedApplicationTelemetryRuntimeSource({ application: graph.metadata.name, service: `query-gateway:${gateway.name}` }) : ''}
