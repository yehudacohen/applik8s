  ...
  return normalizeApplicationGraph({
    ...
    compatibility: {
      ...
      labels: [
        ...
        { name: 'ML.model', surface: 'experimentalSurface', since: 'v0.9', rationale: 'Typed predictive model declarations, deterministic conformance, and compiler-hydrated managed-worker execution are implemented; materially different deployed-provider qualification remains beta.', implementation: 'implemented' },
        { name: 'provider.MLModel', surface: 'experimentalSurface', since: 'v0.9', rationale: 'Qualified predictive providers retain content-addressed artifact and receipt contracts; providers without a portable runtime binding fail closed.', implementation: 'implemented' },
