...
const builtinProviderRegistrations: readonly BuiltinProviderRegistration[] = [
  ...
  { interface: "Certificate", implementation: "acm-certificate", execution: "external-controller" },
  ...
  { interface: "ContainerRegistry", implementation: "ecr", execution: "external-controller" },
  ...
  { interface: "DnsPublication", implementation: "route53-dns-publication", execution: "external-controller" },
  { interface: "EventLog", implementation: "nats-jetstream", execution: "direct-provider" },
  { interface: "EventLog", implementation: "kinesis", execution: "external-controller" },
