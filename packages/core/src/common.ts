...
export type CanonicalHandlerAbiFunctionName = 'handle' | 'capability-request' | 'kubernetes-read' | 'log' | 'cancel';
...
export interface StatusConvention { readonly ownership?: 'lifecycleManaged' | 'handlerAuthoritative'; readonly observedGenerationField: 'observedGeneration'; readonly conditionsField: 'conditions'; readonly phaseField?: string; readonly messageField?: string; readonly reasonField?: string; }
